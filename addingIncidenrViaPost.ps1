...
$uri = "https://${ServiceNowInstance}.service-now.com/api/now/table/incident?sysparm_exclude_reference_link=true&sysparm_fields=number%2Cshort_description"
...
$body = @{
    short_description = "Generated by PowerShe by Chris A"
